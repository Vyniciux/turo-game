...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ...
    ifeq ($(PLATFORM_OS),LINUX)
        ...
        LDLIBS = -lraylib -lGL -lm -lpthread -ldl -lrt -lstdc++ 
        ...
        ifeq ($(USE_WAYLAND_DISPLAY),TRUE)
            LDLIBS += -lwayland-client -lwayland-cursor -lwayland-egl -lxkbcommon -lstdc++
        endif
...
# A partir daqui deveriam ser listados os arquivos que incluem o projeto, porem peguei um trecho de um código disponibilizado pelos monitores que faz isso. By: LeoVyni 2024
